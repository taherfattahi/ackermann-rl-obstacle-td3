...
class ReplayBuffer(object):
    ...
    def sample(self, batch_size):
        """Renamed from sample_batch to sample for compatibility with TD3 code"""
    ...
    def sample_batch(self, batch_size):
        """Keeping original method for backward compatibility"""
...
class RolloutReplayBuffer(object):
    def __init__(self, buffer_size, random_seed=123, history_len=10):
        """
        The right side of the deque contains the most recent experiences
        Useful for sequential modeling with history
        """
        self.buffer_size = buffer_size
        self.count = 0
